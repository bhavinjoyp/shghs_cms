        ...
        return (
            <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
                <div className="bg-white p-8 rounded-2xl shadow-lg text-center max-w-md w-full">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">Gallery Item Created!</h2>
                    <p className="text-gray-600 mb-6">Redirecting you back to the gallery...</p>
                    <Link
                        href="/gallery"
            ...
            <main className="mx-auto max-w-4xl py-10 sm:px-6 lg:px-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g., Summer Art Show"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        placeholder="A short description of the gallery..."
                                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    />
                                </div>
                                <div>
                                    <label htmlFor="youtube_link" className="block text-sm font-medium text-gray-600 mb-1">
                                ...
                                <div className="flex items-center space-x-6 pt-2">
                                    ...
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                        />
                                        <label htmlFor="nursery" className="ml-2 block text-sm text-gray-700">
                                            Nursery category
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-8">
                        ...
                        {uploadedImages.length < 15 ? (
                            <ImageUpload
                                ...
                                title={formData.title || 'gallery-item'}
                                mediaType="gallery"
                            />
                        ) : (
                    ...
                    <div className="flex justify-end space-x-4 pt-4">
                        ...
                        <Button
                            type="submit"
                            disabled={isSubmitting || uploadedImages.length === 0 || !thumbnail}
                            className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400"
                        >
                            {isSubmitting ? (
                                <>
